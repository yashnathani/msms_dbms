                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <p> Book your appointment before visiting.</p>
                            <form method="post">
                                <div class="row">
                                    <div class="col-md-6">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="footer-widget">
                            ...
                            <ul class="listnone contact">
                                <li><i class="fa fa-map-marker"></i> ramna bhagwati courtyard </li>
                                <li><i class="fa fa-phone"></i> 9546177114</li>
                                <li><i class="fa fa-fax"></i> (123) 456 7890</li>
                                <li><i class="fa fa-envelope-o"></i> infomc@salon.com</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="copyright-content">
                                <p>© Men Salon 2022| all rights reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
